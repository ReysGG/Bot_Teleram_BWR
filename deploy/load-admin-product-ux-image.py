...
image=json.loads(subprocess.check_output(['docker','image','inspect','telegram-app:admin-product-ux-20260916']))[0]
assert image['Architecture']=='amd64' and image['Os']=='linux'
subprocess.run(['python3',str(base/'verify-admin-product-ux-content.py')],check=True)
